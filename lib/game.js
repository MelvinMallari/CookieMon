...
class Game {
  ...
  addGhost() {
    const blinky = new Ghost({ 
      ...
      startingPos: [ 12.5*Loader.BLOCK_SIZE, 11.5*Loader.BLOCK_SIZE ]
    });
    ...
    const pinky = new Ghost({ 
      ...
      color: "#FFB8FF", 
      cookieMon: this.cookieMon[0],
      startingPos: [ 14*Loader.BLOCK_SIZE, 11.5*Loader.BLOCK_SIZE ]
    });
    ...
    const inky = new Ghost({ 
      ...
      color: "#00FFFF", 
      cookieMon: this.cookieMon[0],
      startingPos: [ 16.5*Loader.BLOCK_SIZE, 11.5*Loader.BLOCK_SIZE ]
    });
    ...
    const clyde = new Ghost({ 
      ...
      color: "#FFB852", 
      cookieMon: this.cookieMon[0],
      startingPos: [ 18*Loader.BLOCK_SIZE, 11.5*Loader.BLOCK_SIZE ]
    });
