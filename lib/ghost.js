...
class Ghost extends MovingObject {
  constructor(options) {
    ...
    this.animate = true;
    this.numSteps = 0;
    this.pupilOffsetLeft =  [[-4, -5], [-7, -2], [-10, -5], [-7, -8]];
    this.pupilOffsetRight =  [[10, -5], [7, -2], [4, -5], [7, -8]];
    this.eyeOffsets = [[-7, -5], [7, -5]];
  ...
  renderBody() {
    ...
    let [outterOffset, offset1, offset2] = 
      this.animate ? [13, 11, 15] : [10, 15, 11];
